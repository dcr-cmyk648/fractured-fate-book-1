...
Niall Rezin is Maya and Selwin Rezin's father, Alara's widower, and the feared Rezin patriarch.

He is a powerful High Clade magus, military and political authority, and central figure in Maya's inherited standards and family identity.

## Personality and Psychological Patterns

Niall loves Maya and protects his family, but his love is expressed through command, pressure, high standards, and sometimes frightening ruthlessness.
...
Niall is proud of Maya and loves her, but his approval, standards, and perfectionism place heavy pressure on her. Maya carries his standards, fears disappointing him, and must eventually accept him as flawed instead of needing him to embody perfection.
...
- `imports/normalized/melissa-copy.md:19897-19900`: Maya explains Niall's lightning method.
- `imports/normalized/melissa-copy.md:20017-20092`: Niall attacks Davian after the Heart theft while Maya blocks him.
- `imports/normalized/book-1-outline.md:276-326`: political fear of Niall, Drakhal deal, baiting his weakness.
- `imports/normalized/book-1-outline.md:392-430`: Niall's self-proving motive and vulnerability in the raid/Vorren planning.
- `imports/normalized/book-1-outline.md:522-573`: Niall's recovery, Alara/Maya/Selwin, and not using soldiers as expendable distractions.
- `imports/normalized/bullet-notes.md:32`: Heart/silver overcharge note.
- `imports/normalized/bullet-notes.md:62-76`: healer/burned-soldier candidate material.
- `imports/normalized/bullet-notes.md:86`: Maya accepts Niall breaking down instead of demanding perfection.
