...
candidate_file: planning/candidates/characters/char-maya.md
---
...
Maya Rezin is a principal POV character, Rezin heir, High Clade magus, daughter of Niall Rezin and Alara, and older sister to Selwin.

In the current manuscript, she is recognized as Lady Maya and operates under intense Rezin, High Clade, and personal expectations.

## Physical Description

Accepted revision direction:

- Maya has dark eyes with subtle purple rings around the pupil and outer edge of the iris.
- The purple rings reflect her dual heritage through Alara's Naeroth origin.
- Her recurring Presented-magus visual direction includes a high ponytail with a rose-gold ring and expensive sleeveless magus battle clothing with rose-gold accents and boots.

Current manuscript state:

- The normalized manuscript currently describes golden eyes and formal midnight-blue/silver clothing. This is superseded by the approved visual direction above and should be treated as a revision target, not current accepted appearance canon.

## Background

Maya is the daughter of Niall Rezin and Alara. Alara is from Naeroth and would have had fully purple eyes. Maya's dual heritage should matter socially and politically, especially outside the Rezin sphere of influence.

Maya receives racist sentiment because of her dual heritage from people outside Rezin influence. People are afraid to go too far because of Niall and because insults toward Maya imply insults toward Alara.

Broader Naeroth and demi-human worldbuilding belongs in separate entity records. Maya's file should keep only the character-specific implications.

## Personality and Psychological Patterns

Maya is powerful, technically minded, and trained to project command, but she is also anxious, self-blaming, and vulnerable to perfectionism.

Niall's approval matters intensely to her. She carries his standards, fears disappointing him, and tends to respond to crisis by taking responsibility and working rather than processing what happened.

After the citadel attack in the current manuscript, Maya is dissociated, guilty, and shaken by the scale of force she used. She tells Erynn she held the line because no one else could, then moves into investigation and work.

## Abilities

Maya's magic includes:
...
Maya's relationship with Niall is defined by love, approval-seeking, inherited standards, and the need to confront his flaws.

Alara:

Alara is Maya's mother and the source of Maya's Naeroth heritage. Alara's heritage and fateweaving/Convergence-related abilities should be reviewed in Alara and worldbuilding records before being expanded here.
...
- `imports/normalized/melissa-copy.md:670-760`, Chapter 1: post-attack dissociation, guilt, and work-focused response.
- `imports/normalized/melissa-copy.md:15-43`, Chapter 37: training Davian and Selwin, sleep pressure, and Shroud-training memory.
- `imports/normalized/melissa-copy.md:80-120`, Chapter 37: advanced Shroud/schema/heat/flame technique while training Davian.
- `imports/normalized/melissa-copy.md:16935-16985`, Chapter 30: fate/Skein perception and guilt over Davian/Heart theft.
- `imports/normalized/book-1-outline.md:416-470`: candidate end-arc and Vorren-related planning.
- `imports/normalized/bullet-notes.md:119-150`: prologue first-combat/Shroud panic revision notes.
- `imports/normalized/bullet-notes.md:153`, `imports/normalized/bullet-notes.md:195`, `imports/normalized/bullet-notes.md:222`: visual and Naeroth/fateweaving notes.
- `imports/normalized/melissa-copy.comments.md:21-29`, Comment 65: trained authority and Davian misreading.
- `imports/normalized/melissa-copy.comments.md:580-587`, Comment 111: perfectionism and Niall disappointment.
