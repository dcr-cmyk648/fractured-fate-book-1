...
This file owns the physical chamber, access/workplace behavior, and accepted chamber-level containment function. The Heart as an object and its containment/armature relationship belong to `object-seraph-heart`; detailed zán theory belongs to `magic-zan-lattices`; the full theft sequence belongs to `event-heart-theft`.
...
The chamber is huge and open, with a high domed ceiling, glowing zán lighting, and an enormous central Treasury sphere suspended in the middle.
...
The containment armature's accepted function is to contain the Heart and transform or channel its reality-distorting energy into gravity negation as a side effect. The exact zán, sink, and Heart-object mechanics remain for later object and advanced zán reviews.
...
The Treasury chamber is dangerous even for authorized workers. Zánwrights use ropes, anchors, and careful movement in the weightless chamber.
...
The chamber walls and sphere exterior are covered in intricate, redundant zán lattices.

The sphere's lattice reinforces weakened components. Davian cannot easily sabotage the system one zán at a time because when he drains one component, neighboring lattice structures compensate.
...
- Exact zán-sink, Heart-energy transformation, and Nizán-protection mechanics.
...
- `imports/normalized/melissa-copy.md:3888-4029`: high spire access, spiral stairs, huge domed chamber, central floating sphere, weightless work environment, ropes/anchors, zán work.
- `imports/normalized/melissa-copy.md:4490-4545`: redundant sphere lattice and difficulty sabotaging individual zán.
