...
This file owns the Registry as an institution/system. The physical chamber belongs to `loc-registry`; detailed zán-lattice mechanics belong to `magic-zan-lattices`.
...
Maya attempts a band-aid repair after the loss of the Heart causes the Registry to attempt to run a grossly outsized and inefficient system. Her redesign ideas include isolating passive detection, focusing it around entrances or gateways, and using zán sinks or more efficient power arrangements.
