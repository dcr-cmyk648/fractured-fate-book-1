...
display_name: Rezin family / Rezin Clade
status: approved
last_reviewed: 2026-06-24
review_packet: reviews/entities/organizations/org-rezin.md
candidate_file: planning/candidates/organizations/org-rezin.md
---

# Rezin Family / Rezin Clade
...
Niall Rezin is the current feared patriarch and political/military authority.
...
Elric Rezin is a former Rezin patriarch or major Rezin magus, Niall's father, and Maya's grandfather. In this organization record, keep Elric's hidden antagonist role minimal: he has little day-to-day influence on Rezin operations and primarily works through direct character influence and other organizations such as the Harbingers. His earlier political reform desires and influence may inform some Rezin operating differences.
...
The Rezin power base includes:

- the Rezin citadel and its defenses
- soldiers, wall commanders, elite guards, and personal guards
- the Treasury and Heart
- Registry infrastructure and zän-lattice work
- household staff, advisers, healers, zanwrights, and contractors
- Rezin political standing before the High Clade Council

Exact mechanics of the Heart, Registry, Shrouds, silver conduits, citadel layout, High Clade hierarchy, and zän lattices belong to their own entity reviews.

## Culture

Rezin culture reflects general High Clade culture: Presentation, Shroud competence, tactical secrecy, command posture, harsh standards, and the need to project certainty to the people under the Clade's protection or rule.

The Rezin version is comparatively less harsh than other Clades because of the family's apex position and exceptional magi such as Niall and Maya. Selwin's lack of constant extreme training to force Shroud manifestation would be atypical in another Clade, but the Rezins can rely on Niall and Maya in ways more desperate Clades cannot.
...
Later manuscript material shows Selwin guarded by elite Rezin guards, Maya training Selwin inside the citadel, and Maya working on Registry zän lattices while realizing that Rezin authority depends partly on projecting certainty even when the people at the top do not have all the answers.

## Related Files

- Review packet: [org-rezin](../../reviews/entities/organizations/org-rezin.md)
- Candidate material: [org-rezin](../../planning/candidates/organizations/org-rezin.md)
...
- Exact Registry, Heart, Treasury, citadel, Shroud, silver-conduit, and zän-lattice mechanics remain for separate entity reviews.
...
- `imports/normalized/melissa-copy.md:9048-9188`: Rezin family history, Alara's Naeroth origin, Elric's lineage records, and Niall's lack of birth contracts.
- `imports/normalized/melissa-copy.md:13920-13975`: Aldira on Elric's historic High Clade influence.
- `imports/normalized/melissa-copy.md:1-65`: Chapter 37 training, Registry work, and Maya's pressure to project Rezin certainty.
- `imports/normalized/book-1-outline.md:128-136`: Maya's realization about Rezin authority and projecting answers.
