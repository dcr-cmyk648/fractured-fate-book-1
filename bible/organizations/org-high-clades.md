...
candidate_file: planning/candidates/organizations/org-high-clades.md
---
...
The High Clades are the ruling Clade tier of the Six Cities system.

A High Clade is politically defined by holding one of the six citadels that form the core of a city-wedge / legally distinct city in the Six Cities. High Clade status can change through violent displacement. Archeon, for example, was formerly a Low Clade and became a High Clade by killing the prior occupying High Clade and taking the citadel.
...
## Power, Secrecy, and Status

High Clades guard detailed knowledge of their abilities, bloodlines, weaknesses, citadel layouts, and tactical systems. Both High and Low Clades avoid giving away power details that could be exploited in combat.

High Clade families manage lineage, intermarriage, fertility / birth contracts, Shroud training, Presentation, and inherited magical status as power systems.
...
Older High Clade disputes were more formalized, including duels in a central arena where combat usually ended at yield rather than death because High Clade magi were too valuable to waste.
...
- Review packet: [org-high-clades](../../reviews/entities/organizations/org-high-clades.md)
- Candidate material: [org-high-clades](../../planning/candidates/organizations/org-high-clades.md)
...
- `imports/normalized/melissa-copy.md:1425-1449`: Maya's Presentation chamber, six High Clade boxes, six citadels, and current named High Clades.
...
- `imports/normalized/book-1-outline.md:1386-1395`, `imports/normalized/book-1-outline.md:1473-1476`: older formal duel norms and Niall's post-Alara lethal dominance.
- `imports/normalized/book-1-outline.md:6266-6309`: city-wedge governance and High Clade citadel priority notes.
