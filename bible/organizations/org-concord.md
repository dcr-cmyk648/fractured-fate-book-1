...
review_packet: reviews/entities/organizations/org-concord.md
candidate_file: planning/candidates/organizations/org-concord.md
---

# Twilight Concord / Concord

## Identity

The formal name is the Twilight Concord. `Concord` is the short form.

The Twilight Concord is a Masked Clade. Masked Clades are mafia-esque criminal organizations, though the Concord likely considers itself a resistance group against the High Clade class structure.
...
Jalen is a respected support, planning, and logistics figure and Kelyra's husband. He is not the Concord's martial or political leader.
...
Current manuscript material still contains older traces where Harbinger/Syndicate pressure is framed as a threat to Jalen's seat. Accepted direction moves that pressure to Kelyra's position as Concord leader.

Older Jalen-seat and Jalen-Trial material is suspect and should be repaired during Concord chronology or manuscript revision work.

## Related Files

- Review packet: [org-concord](../../reviews/entities/organizations/org-concord.md)
- Candidate material: [org-concord](../../planning/candidates/organizations/org-concord.md)
...
- `imports/normalized/melissa-copy.md:273-336`: Twilight Concord prologue operation, masks, sign, and field discipline.
- `imports/normalized/melissa-copy.md:1059-1065`: older Jalen-seat / Trial of Dominion threat language.
- `imports/normalized/melissa-copy.md:1704-1851`: Concord manor, courtyard, Kelyra's authority, central hall, and Heart-theft planning.
- `imports/normalized/melissa-copy.md:16585-16615`: Kelyra's first Harbinger meeting and Ink-assisted killing of the former Concord leader.
- `imports/normalized/melissa-copy.md:16636-16888`: Karra, Harbinger betrayal, and Trial/penalty setup.
- `imports/normalized/melissa-copy.md:17899-17923`: Concord cipher note.
- `imports/normalized/melissa-copy.md:18151-18160`: maze-like Concord hideout.
- `imports/normalized/melissa-copy.md:18682-18700`: Aldira's record of `Concord org.` and `K. Virellis`.
- `imports/normalized/book-1-outline.md:2589-2592`: Concord sign and leadership-challenge pressure.
- `imports/normalized/book-1-outline.md:2998-3058`: Concord manor and Kelyra as planner.
- `imports/normalized/book-1-outline.md:8170-8212`: Trial of Dominion planning material.
