...
- Source lines: `imports/raw/Lore (running addended version).txt:199`, `:216`, `:229`
- Priority: high
...
## LORE-2026-06-28-002: Creator / Sheol / Nizän Cosmology Boundary

- Source lines: `imports/raw/Lore (running addended version).txt:520`, `:1520`, `:1529`, `:1534`, `:1567`, `:1624`
- Priority: high
- Type: story-bible-review
...
## LORE-2026-06-28-003: Magic Origins and Shroud Architecture

- Source lines: `imports/raw/Lore (running addended version).txt:551`, `:606`, `:622`, `:638`, `:660`, `:923`, `:941`
- Priority: high
- Type: story-bible-review
...
## LORE-2026-06-28-004: Abyssal / Unwoven / Eclipsed / Threadblights

- Source lines: `imports/raw/Lore (running addended version).txt:241`, `:248`, `:260`, `:270`, `:281`
- Priority: medium
- Type: story-bible-review
...
## LORE-2026-06-28-005: Zän Technology Depth and Six Core Forms

- Source lines: `imports/raw/Lore (running addended version).txt:957`, `:973`, `:977`, `:988`, `:1035`
- Priority: medium
- Type: story-bible-review
...
## LORE-2026-06-28-006: Martial Arts and Shroud Arts

- Source lines: `imports/raw/Lore (running addended version).txt:1087`, `:1100`, `:1124`, `:1147`, `:1170`
- Priority: medium
...
- Source lines: `imports/raw/Lore (running addended version).txt:1350`, `:1366`, `:1391`, `:1401`, `:1479`
- Priority: low
- Type: candidate-idea
...
- Source lines: `imports/raw/Lore (running addended version).txt:1311`, `:1651`
- Priority: low
- Type: candidate-idea
...
- Source lines: `imports/raw/Lore (running addended version).txt:37`, `:80`, `:111`, `:126`, `:166`, `:187`
- Priority: medium
- Type: consistency-check
- Proposed routing: source-intake note only unless later conflicts appear
- Blocking: no
- Requires author decision: no

Action: Treat obviously stale material as historical/candidate-only unless the author reopens it.

Known stale examples:

- `Elarion` as the city name is superseded by the Six Cities.
- Ironstriders are removed.
- `glyph`/`sigil` terminology is often superseded by zän framing.
- Jalen as Concord leader / Trial victor is stale; Kelyra owns field leadership and Trial pressure.
- Antithesis as true generational heirloom is false; Kelyra invented that framing.
- Several early High Clade labels/family details remain older candidate material.
