...
- Normalized comment IDs: `wc-c62f668570a79ba2`; `wc-c69689ff6980470b`; `wc-73042f713a67b993`
- Commenter: `DustinR`
- Commenter role: `unverified`
- Target file: `outline/alpha-continuation/units/ch42-kelyra-shroud-maya-attrition.md`
- Target chapter ID: `d1-ch-42`
- Target layer: `next_draft_outline`
- Relevant anchors:
  - `Chapter 42 · Working Chapter Shape`, source lines 44-88
  - `Chapter 42 · Kelyra is present but not yet able to simply walk out or solve the fight.`, source lines 54-99
...
- Related entity IDs: `char-kelyra`; `char-davian`; `char-serathis`; `org-archeon`; `loc-archeon`

Summary: Chapter 42 should establish Drosin as a near-High-Clade-level Archeon combatant and Davian's most dangerous direct Book 1 fight, while clarifying that Kelyra cannot help because she is restrained and Shroud-blocked, not because she is merely physically incapacitated. Kelyra's Shroud manifestation should be the practical mechanism that lets her break free and help defeat Drosin.
