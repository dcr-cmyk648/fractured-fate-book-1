...
|---|---|---|---|---|---|
| WC-2026-06-28-001 | proposed | medium | story-bible-review | `bible/cultures/culture-number-system-zan-script.md` | yes |
| WC-2026-06-28-002 | proposed | low | story-bible-review | `bible/cultures/culture-number-system-zan-script.md` | yes |
| WC-2026-06-28-003 | proposed | medium | chapter-architecture | `bible/locations/loc-sorevin-redbridge.md`; Prologue/Sorevin manor scene | yes |
| WC-2026-06-28-004 | proposed | medium | story-bible-review | `bible/magic/magic-zan-lattices.md` | yes |
