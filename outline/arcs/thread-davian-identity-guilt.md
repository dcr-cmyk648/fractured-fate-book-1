...
review_packet: reviews/entities/threads/thread-davian-identity-guilt.md
candidate_file: planning/candidates/threads/thread-davian-identity-guilt.md
---

# Davian Identity, Guilt, and Agency Arc

This is an approved seed for Davian's broad arc, not a complete chapter-by-chapter outline.

## Approved Arc Direction

Davian begins from negation: wanting to tear everything down, hurt the High Clades, prove agency, and stop feeling helpless by destroying hated things.

His arc moves toward values: valuing Maya, protecting people and things he values, and choosing action because it preserves something rather than only because it satisfies rage or control.
...
The Maya/Davian romance and trust arc remains both real and betrayed.

Davian's attraction to Maya begins as an unparsed rush of feeling around the wall scene, then deepens as he sees Maya's principle, strength, and personhood beneath the perfect exterior.

The relationship matters because it is real. The betrayal matters because he lies, steals the Heart, hurts people under Maya's protection, and nearly kills Niall. One truth does not erase the other.

## Endgame Function

Davian resolves enough of the Kelyra/Serathis origin-family wound to go help Maya and Niall against Vorren.
...
- Review packet: [thread-davian-identity-guilt](../../reviews/entities/threads/thread-davian-identity-guilt.md)
- Candidate material: [thread-davian-identity-guilt](../../planning/candidates/threads/thread-davian-identity-guilt.md)
...
- Related character: [Arrek Hadrin](../../bible/characters/char-arrek.md)
- Related character: [Selwin Rezin](../../bible/characters/char-selwin.md)
- Related arc: [Maya / Davian romance and trust arc](thread-maya-davian-romance.md)
- Related arc: [Kelyra Archeon trauma and family-protection arc](thread-kelyra-archeon-recovery.md)
- Related arc: [Niall grief, rigidity, and recovery arc](thread-niall-grief-recovery.md)
...
- `outline/arcs/thread-maya-davian-romance.md`
- `outline/arcs/thread-kelyra-archeon-recovery.md`
- `bible/events/event-heart-theft.md`
- `imports/normalized/melissa-copy.md:984-1167`: Harbinger/Syndicate meeting, Heart mission, Davian volunteering, Ink Pact ritual.
- `imports/normalized/melissa-copy.md:20185-20230`: Davian admits aura theft and murdering Arrek.
- `imports/normalized/melissa-copy.md:21080-21695`: Davian's post-theft training, weak Shroud, and apology to Selwin.
- `imports/normalized/book-1-outline.md:413-417`: Davian's arc away from needing to be the threat.
- `imports/normalized/book-1-outline.md:9305-9623`: post-theft Davian planning and self-sabotage.
