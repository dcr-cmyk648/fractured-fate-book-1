# Detailed Alpha Unit Outline: Chapter 39
...
Chapter 38 ends with:

- Davian checking on Jalen in the morning;
- Aldira already present and coordinating with Jalen;
- Jalen badly injured but adaptable enough to help;
- Maya arriving before she and Davian can resolve the failed night conversation;
- a runner announcing that Drakhal has arrived to parlay and Maya is needed in the throne room;
- Davian following Maya toward the public crisis.

## Political Context to Preserve

This scene follows the prior Central Spire public-provocation sequence:

- Evana already tested whether Niall would attack her publicly or fail to appear.
- Niall's refusal to attack became a data point suggesting possible weakness, but not proof.
- Drakhal now escalates by coming to Rezin with allied or proposal-supporting High Clades.
- The Rezin-citadel parlay repeats the trap in Rezin's own space: provoke Niall, pressure Maya, and force a legitimacy crisis.
- Evana's likely backup plans include either a direct Drakhal confrontation supported by allied High Clades or an Archeon strike where Serathis/Vorren's trap waits.
...
- The audience/witness structure matters: enough allied High Clade eyes are present to make Niall's response politically useful to Drakhal.
...
- Maya marries Caius.
- Niall is banished, steps aside, or is removed from effective control.
- Rezin citadel and legitimacy pass peacefully under a new arrangement.
- The marriage is framed as continuity, not conquest: Caius gets access to Rezin legacy through Maya.
- Evana can use Shade accusations, Rezin tyranny, Niall's prior violence, and the instability after the Heart theft without openly saying the Heart is gone.
- Evana does not need to tell the truth. She can bend or invert facts as needed.

Purpose:

- Put Maya's body/status/legacy at the center of the political trap.
...
- The point is that he treats Maya as claimable.
- Maya may be furious, controlled, threatened, disgusted, or caught between public role and personal reaction.
- Davian reacts impulsively and violently.
...
- Clarify that Spire provocation and Rezin parlay are linked stages.
...
- exact Archeon trap;
- Vorren's role as final underground weapon, unless already known by implication elsewhere;
- Elric's full manipulation;
- detailed assault route.

## Consistency Checks

- This follows the Spire provocation; it does not replace it.
