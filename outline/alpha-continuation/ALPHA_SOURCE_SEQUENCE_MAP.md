# Alpha-Continuation Source Sequence Map

## Purpose

This packet revises the first alpha-continuation kickoff after author feedback that the initial sequence list skipped too much remaining material. It digs deeper into the current maps, accepted story-bible records, and original outline notes to create a fuller high-level map from the current Chapter 37 fragment through the accepted Book 1 ending.

This is architecture only. It does not draft prose, edit manuscript files, assign final chapter numbers, or lock detailed scene choreography.

## Current source basis

- `revision/current-draft-map/d1-ch-37-preposed.md`: approved as the opening of the next alpha-continuation unit, not as a complete chapter.
- `revision/current-draft-map/d1-ch-25.md` and `d1-ch-26.md`: earlier current-draft source for dining hall, Selwin, Archeon gauntlets, Shroud instruction, and Davian's first Shroud/Ink realization. These functions should not be forgotten, but in alpha continuation they are echoes, developments, or redistributed functions after the Heart theft, not a clean duplicate.
- `revision/current-draft-map/d1-ch-27.md`: earlier current-draft source for Drakhal political provocation, Niall/Maya rupture, and first kiss. The new post-Heart version should reuse only the relevant political architecture and relationship pressure.
- `revision/current-draft-map/d1-ch-29.md`: Heart delivery to Harbingers/Vorren, Harbinger betrayal, Karra healing reversal, and Kelyra's capture by Serathis.
- `revision/current-draft-map/d1-ch-31.md` through `d1-ch-36.md`: Davian's return, Archeon attack at the Concord manor, Rezin custody, Zirene bands, Niall/Maya/Davian conflict, Kelyra captivity, Harvick Ink reveal, and Davian/Selwin training.
- `imports/normalized/book-1-outline.md:95-145`: Chapter 37 training, dining, sleep-deprivation, Archeon pressure, and Maya/Davian threshold notes.
- `imports/normalized/book-1-outline.md:165-215`: nighttime Maya/Davian vulnerability, parent-shadow, "questions not answers," Maya's permanent Shroud, and extended downtime.
- `imports/normalized/book-1-outline.md:270-360`: Drakhal/Archeon proposal, Maya-Caius marriage / Niall banishment, Niall's immediate turn to assault planning, scout/raid notes, and neglected wedge approach.
- `imports/normalized/book-1-outline.md:9165-9293`: detailed dining hall, Archeon-gauntlet study, cognition/focus myth, Archeon predictability, quiet corridor, and next-action notes.
...
- Character movement:
  ...
  - Selwin remains an emotional/training mirror, not just a cute interruption.
  - Harvick becomes useful as translator between body forms, older training, and tactical counter-plan.
- Relationship movement:
  - Maya/Davian moves warmer but not cleanly forgiving.
...
- Likely POV: Maya, possibly with Davian hidden or restricted.
- Purpose: externalize the political trap and force Niall into the decision that launches the raid.
- Starting state: Rezin is preparing but has not chosen open war. Drakhal/Archeon and allied High Clades still want proof or exposure of Niall's weakness.
- Ending state: Niall publicly keeps control, then privately pivots to killing them / attacking Archeon.
- Major movement:
  - Drakhal arrives with allies, and Archeon involvement is visible or represented.
...
- Character movement:
  ...
  - Maya mistakes inclusion in violence as trust.
  - Davian's jealousy/protectiveness can flare if he is present.
- Relationship movement:
  - Maya/Niall: apparent trust masks Niall's desperation.
  - Maya/Davian: the marriage proposal can add jealousy, fear, and urgency without becoming melodrama.
- Magic/worldbuilding:
  - High Clade political theater after Heart theft.
  - Marriage/banishment as legitimacy transfer.
  - Drakhal plausible deniability and coalition-building.
- Source anchors:
...
- Likely POV: Maya or Davian.
- Purpose: convert Niall's decision into operational action while surfacing the moral and relationship stakes.
...
- Major movement:
  ...
  - Davian tries or fails to confess something to Maya before the raid.
  - Maya and Davian have a pre-raid argument where insecurities surface.
  - Niall may finally frame Davian as not only a tool.
- Character movement:
  - Niall regresses and partially grows at the same time.
  - Maya wants to be trusted and therefore follows a plan that may be morally suspect.
  - Davian wants to be useful without becoming only a weapon.
- Relationship movement:
  - Pre-raid Maya/Davian tension remains unresolved to make death/resurrection payoff stronger.
  - Harvick/Davian mentor handoff may matter if Harvick stays back.
- Magic/worldbuilding:
  - Assault logistics under High Clade assumptions.
  - Forerunner/scout culture.
  - Davian's current weapon choice and Antithesis/Harvick-sword question.
- Source anchors:
  - `book-1-outline.md:312-350`.
  - `bullet-notes.md:48-63`.
- Open questions:
  - Does Davian carry Harvick's sword, Antithesis, or both, and when?

### alpha-seq-007: Approach through the neglected wedge and Archeon breach

- Likely POV: Maya, with possible Davian inserts.
- Purpose: move into Archeon while showing the social cost of High Clade rule and the odd weakness of outer resistance.
- Starting state: the assault party enters neglected city-wedge boundary/slum territory.
- Ending state: the party breaches Archeon and reaches the split point.
- Major movement:
  - Approach is aboveground through neglected wedge/slum boundary.
  - Maya sees that while she has been solving high-level arcane problems, many people barely survive.
  - Niall frames hierarchy as natural order, exposing the worldview Maya must surpass.
  - Niall/Maya/Davian breach gates/towers/wards.
  - Resistance is oddly weak because Serathis is holding back valuable magi.
  - Davian may try a technical solution to a warded door and Maya simply blows it open, preserving tone and power contrast.
- Character movement:
  - Maya's social conscience and High Clade identity collide.
  - Niall's old logic is on full display.
  - Davian sees what Rezin power looks like from inside the assault.
- Relationship movement:
  - Maya/Davian/Niall temporarily function together while values remain strained.
- Magic/worldbuilding:
  - City wedge boundary geography.
  - Archeon citadel defenses.
  - High Clade assault scale.
- Source anchors:
  - `book-1-outline.md:356-360`.
  - `bible/locations/loc-archeon-citadel.md` if opened in detailed pass.
- Open questions:
  - Exact breach route and whether named scouts die.

### alpha-seq-008: Split paths - Davian to Kelyra, Maya/Niall to the tower

- Likely POV: split Davian/Maya.
- Purpose: branch simultaneous final conflicts without making the split feel arbitrary.
- Starting state: the group is inside Archeon and resistance patterns are wrong.
- Ending state: Davian is committed to Kelyra's rescue path while Maya/Niall continue to Serathis's main trap.
- Major movement:
  - Davian gets specific information or a leak pointing toward Kelyra's holding place.
  - Serathis may have arranged the leak to remove Davian from the main trap.
  - Niall is indifferent or hostile to delaying for Kelyra; Maya and Davian negotiate or clash over the split.
  - Time pressure matters: Davian fears execution, use, or breeding/weaponization before rescue.
  - Maya lets or trusts Davian to go, feeling she is also abandoning Niall.
- Character movement:
  - Davian chooses Kelyra while still tied to Maya.
  - Maya must choose trust/delegation under pressure.
  - Niall's utilitarian logic becomes uglier.
- Source anchors:
  - `decisions/0083-endgame-archeon-assault-character-agency.md`.
  - Current author clarification in this checkpoint.
- Open questions:
  - Who leaks the exact Kelyra route and how explicit the trap is.

### alpha-seq-009: Kelyra rescue and Shroud manifestation

- Likely POV: Davian, possibly with Kelyra internal beats if needed.
- Purpose: resolve Kelyra's captivity arc enough for her to act against Serathis and choose what comes next.
- Starting state: Kelyra is captive, pressured, possibly being forced into weapon work or used as leverage.
- Ending state: Kelyra manifests a Shroud, Davian/Kelyra defeat the immediate heir/magus threat, and they move toward the main fight.
- Major movement:
  - Davian fights a remaining valuable Archeon heir/magus, Drosin-like opponent, or equivalent trap.
  - Kelyra is forced to confront Serathis's training/fear logic.
  - Davian calls out being enslaved to fear/revenge and asks for help/protection rather than vengeance.
  - Kelyra manifests a Shroud and helps defeat the opponent.
  - Kelyra may claim or later receive the dual returning daggers made by Zirene/Serathis path.
- Character movement:
  - Davian rejects Kelyra's old script without rejecting Kelyra.
  - Kelyra breaks the Shroud block by choosing protection/action under her own values.
- Source anchors:
  - `d1-ch-35`.
  - `book-1-outline.md:366-379`.
  - `book-1-outline.md:3669-3689` from prior search output.
- Open questions:
  - Opponent identity and whether Kelyra's Shroud moment happens before or during the Serathis confrontation.

### alpha-seq-010: Throne-room trap and Maya attrition

- Likely POV: Maya.
- Purpose: spring Serathis's real trap and isolate Niall underground with Vorren.
- Starting state: Maya/Niall enter the central tower/throne-room path.
- Ending state: Niall is dropped into the subterranean trap; Maya is pinned above by Serathis and held-back Archeon magi.
- Major movement:
  - Niall kills apparent defenders, possibly servants/children/randoms positioned to bait his old terror logic.
  - Stained-glass Creator-worship remnants frame the throne room.
  - Maya notices lack of Shroud flashes or other clues that resistance is wrong.
  - Serathis triggers floor collapse.
  - Niall falls toward Vorren.
  - Serathis and held-back Archeon magi keep Maya from following immediately.
- Character movement:
  - Niall's rigidity and need to prove strength make him vulnerable.
  - Maya must fight under acute time pressure and realize "winning" the first layer was a trap.
- Source anchors:
  - `book-1-outline.md:3550-3656`.
  - Archeon location and Serathis records.
- Open questions:
  - How much of Niall killing decoys is retained in final alpha, given moral weight.
...
- Major movement:
  - Davian/Kelyra relieve enough pressure for Maya to reach Niall.
  - Davian/Kelyra fight Serathis and/or remaining Archeon elite.
  - Serathis reveals her burn-the-system-down motive and her view that Kelyra was worth the abuse.
  - Kelyra kills Serathis or is crucial in doing so.
  - Maya reaches Niall, who is beat down, blaming himself, and tempted to withdraw.
  - Vorren mocks Niall, the silver, and/or the insufficiency of Archeon tricks against true force.
  - Maya sees broken Niall and accepts him rather than demanding perfection.
  - Davian leaves Kelyra to help Maya/Niall despite Kelyra not wanting him to.
  - Davian blocks Vorren's attack, stepping forward through past/future fear, and Antithesis is ruined defensively.
  - Maya uses hand-to-hand/body-focus/counter lessons from Davian and Archeon research.
  - Maya opens the ceiling; Niall follows Maya's flame/light upward and channels lightning; together they destroy Vorren beyond regeneration.
- Character movement:
  - Davian gives up being "the threat" and becomes support/protector.
  - Maya gives up having to win alone and asks/uses help.
  - Niall accepts help and reconnects with the living.
  - Kelyra rejects Serathis's ownership.
- Source anchors:
  - `book-1-outline.md:382-588`.
...
- Likely POV: Maya.
- Purpose: turn apparent victory into Elric's real endgame move and force Maya into resurrection.
- Starting state: Vorren is defeated; the protagonists are exhausted and barely standing.
- Ending state: Davian is resurrected, the Skein is damaged/interacted with, Maya has encountered Elric in the void/Skein, and the extraplanar eye has been glimpsed.
- Major movement:
  - Elric appears or reveals himself after Vorren's defeat, possibly with "that is why you always have a backup plan."
  - Elric kills Davian, likely with lightning or Ink-enabled force.
  - Davian's genuine smile / unfinished confession can land before or around death.
  - Maya goes into the Skein/void outside ordinary time.
  - Elric tells Maya he cannot act there the same way she can; that is why he brought her there.
  - Elric explains or reveals enough of original sin, damaged reality, the Creator/Sheol interpretation, and six-strand structure without resolving all cosmology.
  - Maya rejects the presented rules and resurrects Davian.
  - The extraplanar deity's diamond-like eye appears right before Maya returns to real space.
  - Elric escapes; the protagonists are in no shape to pursue.
- Character movement:
  - Maya breaks the ultimate rule out of connection and need, proving both Elric's danger and the story's anti-deterministic hope.
  - Elric's "leaning on the scales" becomes visible.
  - Davian's death/resurrection completes the Book 1 emotional pivot without resolving all consequences.
- Source anchors:
  - `book-1-outline.md:598-691`.
  - `bullet-notes.md:27`, `bullet-notes.md:39`, `bullet-notes.md:45`, `bullet-notes.md:60`, `bullet-notes.md:105`.
  - `outline/arcs/thread-elric-reality-skein.md`.
- Open questions:
  - Exact Elric dialogue and how much original-sin cosmology is shown.
  - Exact resurrection cost/mechanics.
...
- Major movement:
  - Elric runs off and cannot be chased.
  - The group exits Archeon.
  - Kelyra appears on the way out and considers killing Niall/Maya or at least trying.
  - Davian stands against Kelyra and returns with the Rezins.
  - Kelyra's position as future/new Archeon head or anti-Clade actor remains open but directional.
  - Jalen later goes to Kelyra.
- Character movement:
  - Davian chooses against Kelyra's revenge path without ceasing to love his family.
  - Kelyra becomes dangerous and changed rather than simply rescued.
  - Maya sees Davian choose return, but this should not flatten the unresolved trauma.
- Source anchors:
  - Current author clarification in this checkpoint.
  - Kelyra and Davian accepted character files.
- Open questions:
  - How far Kelyra goes toward trying to kill Niall/Maya.
  - Whether Kelyra explicitly claims Archeon here.
...
- Character movement:
  - Niall accepts Davian enough to give a gift rather than only a control mechanism.
  - Davian chooses a future not wholly dictated by Kelyra, Niall, Elric, or the past.
  - Maya/Davian ends with hope, consequence, and unresolved fear rather than a clean romance bow.
- Source anchors:
  - `book-1-outline.md:718-733`.
...
- Do not duplicate Chapters 25-27 as if they never happened. Use those maps as source functions, but preserve the new post-Heart state.
- Do not let Chapter 37 become only dinner/research; it also has to carry Maya's overwork, Registry vulnerability, Selwin pressure, and renewed-but-wounded Davian intimacy.
- Do not let Chapter 38 reset Davian to pre-Shroud. He already has martial arts, Ink movement, Shroud access, and training; his missing piece is solid kinesis integration and stable whole-system use.
- Do not skip Jalen's return, because it solves intelligence/logistics and explains his absence from the final assault.
- Do not skip the charged nighttime Maya/Davian scene if the romance/parent-shadow material is needed before the political trap.
- Do not collapse the Drakhal proposal into the old Central Spire scene. The current post-Heart version is at Rezin or otherwise directly tied to Maya marriage/Niall banishment and assault launch.
- Do not make the final battle linear from one POV only if simultaneous pressure is needed; the rescue, throne-room trap, Serathis fight, and Vorren fight should intercut or be carefully sequenced.
- Do not make Elric's final move feel like a random extra boss. It is the real endgame after the physical fight.
