...
entity_type: culture
display_name: Naeroth and non-human lineages candidates
status: candidate
review_packet: reviews/entities/cultures/culture-naeroth-lineages.md
accepted_file: bible/cultures/culture-naeroth-lineages.md
---

# Naeroth and Non-Human Lineages Candidates
...
- Other non-human groups, including dwarf/orc-like candidate peoples, subtle traits, number of races, and social roles.
- Demi-human mercenary forces and death-payment economics.
- Exact racist rumors about Alara bewitching Niall and Davian hearing those claims.

## Routing

- Accepted Naeroth lineage facts: `bible/cultures/culture-naeroth-lineages.md`
- Broader non-human peoples/race taxonomy: `culture-demi-human-peoples`
- Convergence mechanics: `magic-convergence-heat-transfer`
- Fateweaving/Skein mechanics: `bible/magic/magic-fateweaving-skein.md`
- Alara biography, exact abilities, death, and war-memory material: `char-alara` and `event-alara-death-war-memory`
- Selwin's mixed-heritage ability implications: `char-selwin` and later magic reviews
- Davian's racist/cultural anxiety about attraction to Maya: `thread-maya-davian-romance`
